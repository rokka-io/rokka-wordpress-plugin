...
Installing "rokka-image-cdn" can be done either by searching for "rokka-image-cdn" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
