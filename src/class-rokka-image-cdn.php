...
class Rokka_Image_Cdn {
	...
	public function register_post_type ( $post_type = '', $plural = '', $single = '', $description = '', $options = array() ) {
		...
		$post_type = new Rokka_Image_Cdn_Post_Type( $post_type, $plural, $single, $description, $options );
	...
	public function register_taxonomy ( $taxonomy = '', $plural = '', $single = '', $post_types = array(), $taxonomy_args = array() ) {
		...
		$taxonomy = new Rokka_Image_Cdn_Taxonomy( $taxonomy, $plural, $single, $post_types, $taxonomy_args );
	 ...
	 * @static
	 * @see rokka-image-cdn()
	 * @return Main rokka-image-cdn instance
	 */
